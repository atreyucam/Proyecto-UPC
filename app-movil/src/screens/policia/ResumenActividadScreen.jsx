  ...
  return (
    <ScrollView contentContainerStyle={styles.container}>
      ...
      <Card style={styles.card}>
        ...
        <Card.Content>
          {Object.entries(policiaData.resumen_solicitudes_asignadas).map(
            ([tipo, cantidad]) => (
      ...
      <Card style={styles.card}>
        ...
        <Card.Content>
          {policiaData.solicitudes_asignadas.map((solicitud) => (
            ...
            >
              <View style={styles.tableRow}>
                <Text style={styles.tableCell}>{solicitud.id_solicitud}</Text>
                <Text style={styles.tableCell}>{solicitud.estado}</Text>
                <Text style={styles.tableCell}>{solicitud.subtipo}</Text>
              </View>
            </TouchableOpacity>
          ))}
        </Card.Content>
