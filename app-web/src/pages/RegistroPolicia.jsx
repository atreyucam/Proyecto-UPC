...
const RegistroUsuario = () => {
  ...
  const [tipoRegistro, setTipoRegistro] = useState("Policía"); // "Policía" o "Administrador"
  ...
  const handleSubmit = async () => {
    ...
    // Cambia endpoint y mensajes según tipo
    const endpoint =
      tipoRegistro === "Administrador"
        ? "/persona/nuevoAdmin"
        : "/persona/nuevoPolicia";
    const mensajeExito =
      tipoRegistro === "Administrador"
        ? "Administrador registrado exitosamente."
        : "Policía registrado exitosamente.";

    try {
      await axios.post(`${API_URL}${endpoint}`, nuevoUsuario);
      alert(mensajeExito);
    ...
    <div className="flex flex-col items-center gap-4">
      ...
      <div className="flex gap-6">
        ...
        >
          ...
          <p className="mt-2 text-lg font-semibold">Agregar Administrador</p>
        </div>
      </div>
          ...
          <div className="bg-white shadow-lg rounded-lg p-8 w-full max-w-3xl relative">
            ...
            <div className="grid grid-cols-3 gap-6 mt-4">
              ...
              >
                ...
                {subzonas.map((s) => (
                  <option key={s.id_subzona} value={s.id_subzona}>
                    {s.nombre_subzona}
                  </option>
                ))}
              </select>
