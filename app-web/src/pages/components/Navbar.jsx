                ...
                <div className="flex items-center">
                    ...
                    <div className="relative">
                        ...
                        {showPopup && notificaciones.length > 0 && (
                            <div className="absolute top-10 right-10 bg-white p-3 rounded-lg shadow-lg border border-gray-300">
                        ...
                        {/* 🛎️ Ícono de notificación con contador */}
                        <Menu>
                            <MenuHandler>
                            ...
                            <MenuList className="w-80 border-0">
                                ...
                                {notificaciones.length === 0 ? (
                                    ...
                                    notificaciones.slice(-5).map((noti, index) => (
                                        <MenuItem key={index} className="flex items-center gap-3">
                                            ...
                                            <button onClick={() => eliminarNotificacion(noti.id)}>
