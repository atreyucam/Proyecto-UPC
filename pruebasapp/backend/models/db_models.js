...
const AsignacionRol = sequelize.define(
  "AsignacionRol",
  {
    id_asignacion: {
      type: DataTypes.INTEGER,
...
const PersonaZona = sequelize.define(
  "PersonaZona",
  {
    id_zonaAsignacion: {
      type: DataTypes.INTEGER,
...
const SolicitudRegistrada = sequelize.define(
  "SolicitudRegistrada",
  {
    id_solicitud: {
      type: DataTypes.INTEGER,
...
const EventoSolicitud = sequelize.define(
  "EventoSolicitud",
  {
    id_evento: {
      type: DataTypes.INTEGER,
...
Persona.hasMany(SolicitudRegistrada, {
  foreignKey: "id_persona_policia",
  as: "Policia",
});
SolicitudRegistrada.belongsTo(Persona, {
  foreignKey: "id_persona_policia",
  as: "Policia",
});

Persona.hasMany(SolicitudRegistrada, {
  foreignKey: "id_persona_solicitante",
  as: "Solicitante",
});
SolicitudRegistrada.belongsTo(Persona, {
  foreignKey: "id_persona_solicitante",
